              ...
              Expanded(
                ...
                () => ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (index != 0) {
                        if (chatsController.messagesWithUser[index]['from'] ==
                            chatsController.messagesWithUser[index - 1]
                                ['from']) {
                          tail = false;
                        }
                      }
                          ...
                          child: Column(
                            children: [
                              ...
                              BubbleSpecialOne(
                                ...
                                tail: tail,
                                sent: (chatsController.messagesWithUser[index]
                                            ['from'] ==
                                        username)
                                    ? true
                                    : false,
                                delivered: (chatsController
                                            .messagesWithUser[index]['from'] ==
                                        username)
                                    ? true
                                    : false,
                                seen: (chatsController.messagesWithUser[index]
                                            ['from'] ==
                                        username)
                                    ? true
                                    : false,
